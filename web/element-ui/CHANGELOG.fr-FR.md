...
- Cascader
  - Ajouter plusieurs mode et cn.commodityManagement.filter-method (#15611 by @SimonaliaChen)
- Message
...
- Table
  - La méthode `cn.commodityManagement.filter-method` a maintenant un troisième paramètre `column`, #9196 (par @liyanlong)
- DatePicker
