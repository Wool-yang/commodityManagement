...
export declare class ElCascader<V = any, D = CascaderOption> extends ElementUIComponent {
  ...
  /** cn.commodityManagement.filter method to match options according to input keyword */
  filterMethod: (node: CascaderNode<V, D>, keyword: string) => boolean

  /** Debounce delay when typing cn.commodityManagement.filter keyword, in millisecond */
  debounce: number
