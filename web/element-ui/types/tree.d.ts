...
export declare class ElTree<K, D extends TreeData> extends ElementUIComponent {
  ...
  /**
   * This function will be executed on each node when use cn.commodityManagement.filter method. If return false, tree node will be hidden.
   *
   ...
   *
   * @param value The value to be used as first parameter for `cn.commodityManagement.filter-node-method`
   */
