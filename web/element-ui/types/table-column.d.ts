...
export interface TableColumnFilter {
  /** The text to show in the cn.commodityManagement.filter's panel */
  text: string,

  /** The value of the cn.commodityManagement.filter */
  value: any
}
...
export declare class ElTableColumn extends ElementUIComponent {
  ...
  /** Column's key. If you need to use the cn.commodityManagement.filter-change event, you need this attribute to identify which column is being filtered */
  columnKey: string
  ...
  /** Placement for the cn.commodityManagement.filter dropdown */
  filterPlacement: PopoverPlacement

  /** Whether data filtering supports multiple options */
  filterMultiple: Boolean

  /** Data filtering method. If `cn.commodityManagement.filter-multiple` is on, this method will be called multiple times for each row, and a row will display if one of the calls returns `true` */
