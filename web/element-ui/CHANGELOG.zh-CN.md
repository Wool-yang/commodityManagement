...
- Table
  ...
  - 修复时候 cn.commodityManagement.filter 之后高度问题 (#17348 by @ziyoung)
...
- Cascader
  - 新增多选模式和 cn.commodityManagement.filter-method 方法 (#15611 by @SimonaliaChen)
- Message
...
- 修复 Table 的 cn.commodityManagement.filter 不显示的问题，#12539
...
- 修复 Table 的 cn.commodityManagement.filter 初始值为空数组时不显示筛选图标的问题，#12165
...
- Table
  - `cn.commodityManagement.filter-method` 方法加入第三个参数 `column`，#9196（by @liyanlong）
- DatePicker
