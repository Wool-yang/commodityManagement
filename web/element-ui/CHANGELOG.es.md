...
- Select
  - Se usa la opcion placeholder del label para poner el placeholder en el modo cn.commodityManagement.filter (#14989 by @ibufu)
...
- Arreglada la tabla que no mostraba el ícono del filtro cuando a `cn.commodityManagement.filter` se les asignaba un array vacío, #12165
...
- Table
  - El `cn.commodityManagement.filter-method` ahora tiene un tercer parámetro `column`, #9196 (by @liyanlong)
- DatePicker
